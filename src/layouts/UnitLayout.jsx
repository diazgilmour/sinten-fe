...
const UnitLayout = ({ children, title, actions }) => {
  ...
  // Otomatis buka dropdown menu jika URL mengandung /surat
  useEffect(() => {
    // Gunakan /surat sebagai penanda karena Unit Dashboard & Unit Surat masuk di sini
    if (location.pathname.includes("/surat")) {
  ...
  const getMenuItems = () => {
    ...
    const baseMenu = [
      {
        // 🔥 PERBAIKAN: Gunakan path Statis '/unit/dashboard', bukan dinamis
        path: "/unit/dashboard",
        label: "Dashboard",
      ...
      },
      {
        ...
        hasDropdown: true,
        // 🔥 PERBAIKAN: Gunakan path Statis '/unit/surat'
        path: "/unit/surat",
        dropdownItems: [
          {
            path: "/unit/surat?filter=kunjungan-kerja",
            label: "Kunjungan Kerja",
            icon: <Briefcase className="h-4 w-4" />,
          },
          {
            path: "/unit/surat?filter=kunjungan-tamu",
            label: "Kunjungan Tamu",
            icon: <User className="h-4 w-4" />,
          },
          {
            path: "/unit/surat?filter=lainnya",
            label: "Lainnya",
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/" className="flex items-center gap-2 group">
                ...
                />
                <span className="font-bold text-xl text-gray-900 hidden sm:block group-hover:text-indigo-600 transition-colors duration-300">
                  SINTEN
                </span>
              </Link>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                >
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-indigo-600 flex items-center justify-center text-white font-semibold shadow-md transform transition-all duration-300 group-hover:scale-110">
                  ...
                  <svg
                    className={`hidden sm:block w-4 h-4 text-gray-400 group-hover:text-indigo-600 transition-all duration-300 ${
                                ...
                                <Link
                                  ...
                                  ${
                                    isItemActive
                                      ...
                                      : "text-gray-600 hover:bg-white hover:text-indigo-700 hover:border hover:border-gray-200 hover:shadow-sm border border-transparent"
                                  }
                                `}
                                >
                                  {dropdownItem.icon}
